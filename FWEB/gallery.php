                        ...
                        <ul class="nav">
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="distinct.php?ctg=2D Animation">3D Animation</a></li>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="text-left">
                                    Categories : <a href="distinct.php?ctg=<?php echo $data['kategori'];  ?>" target=" _blank"><?php echo $data['kategori']; ?></a>
                                </div>
